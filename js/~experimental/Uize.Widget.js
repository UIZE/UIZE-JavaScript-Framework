...
Uize.module ({
	...
	builder:function (_superclass) {
		...
		/*** Class Constructor ***/
			var
				_class = _superclass.subclass (
					...
					function () {
						this._readyToApplyUnappliedChildrenData = _true;
						this._applyUnappliedChildrenData ();
					}
				),
		...
		/*** Private Instance Methods ***/
			...
			_classPrototype._applyUnappliedChildrenData = function () {
				var
					_this = this,
					_unappliedChildrenData = _this._unappliedChildrenData
				;
				if (_unappliedChildrenData) {
					alert (_unappliedChildrenData.toSource ());
					var
						_children = _this._children,
						_widgetClass,
						_child
					;
					for (var _childName in _unappliedChildrenData) {
						var _unappliedChildrenDataForChild = _unappliedChildrenData [_childName];
						delete _unappliedChildrenData [_childName];
						if (_child = _children [_childName]) {
		...
		/*** Public Instance Methods ***/
			...
			/*** Hierarchy Related Methods ***/
				_classPrototype.addChild = function (_childName,_childInstanceOrClass,_properties) {
					...
					/*** apply declarative syntax data (if present) ***/
					...
					/*** apply unapplied data for child (set through children set-get property) ***/
						var
							_unappliedChildrenData = _this._unappliedChildrenData,
							_unappliedChildrenDataForChild = _unappliedChildrenData && _unappliedChildrenData [_childName]
						;
						if (_unappliedChildrenDataForChild) {
							Uize.copyInto (_properties,_unappliedChildrenDataForChild);
							delete _unappliedChildrenData [_childName];
						}
			...
			_class.registerProperties ({
				...
				_children:{
					...
					conformer:function (_value) {
						_value && Uize.copyInto (this._unappliedChildrenData || (this._unappliedChildrenData = {}),_value);
						this._readyToApplyUnappliedChildrenData && this._applyUnappliedChildrenData ();
