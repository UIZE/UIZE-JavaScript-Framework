	...
	builder:function () {
		...
		function _setMethodTest (_title,_isInstance) {
			return {
				...
				test:[
					{
						title:'Test that values can be set for multiple properties by calling the set method with a single argument, which is an object containing an arbitrary number of property name to property value mappings',
						test:function () {
							...
							return (
								...
								this.expect ('property2Value',_testContext._property2) &&
								this.expect ('property3Value',_testContext._property3)
							);
						}
					},
					{
						title:'Test that a value can be set for a single property by calling the set method with two arguments, where the first argument is the property\'s name and the second is the property\'s value',
						test:function () {
							var _Subclass = Uize.subclass ();
					...
					{
						title:'Test that values can be set for multiple properties by calling the set method with more than two arguments, where the arguments are property name-value pairs',
						test:function () {
							var _Subclass = Uize.subclass ();
							_Subclass.registerProperties ({
								_property1:'property1',
					...
					{
						title:'Test that, when a private name for a set-get property is different from its publice name, the set method does not set a value for a property using the public name of the set-get property',
						test:function () {
							var _Subclass = Uize.subclass ();
							_Subclass.registerProperties ({_property1:'property1'});
							var _testContext = _isInstance ? new _Subclass : _Subclass;
							_testContext.set ('property1','property1Value');
							return this.expect (undefined,_testContext.property1);
						}
					}
				]
			};
		...
		function _getMethodTest (_title,_isInstance) {
			/*
				- test that set-get properties can be accessed directly by their private names
			*/
			return {
				title:_title,
				test:[
					{
						title:'Test that the value of a single set-get property can be obtained by calling the get method with a single string argument, specifying the name of the property',
						test:function () {
							var _Subclass = Uize.subclass ();
							_Subclass.registerProperties ({
								_property1:{
					...
					{
						title:'Test that values can be obtained for multiple properties by calling the get method with a single argument, which is a list of property names',
						test:function () {
							var _Subclass = Uize.subclass ();
							_Subclass.registerProperties ({
								_property1:{
					...
					{
						title:'Test that values can be obtained for all properties by calling the get method with no arguments',
						test:function () {
							var _Subclass = Uize.subclass ();
							_Subclass.registerProperties ({
								_property1:{
					...
					test:[
						{
							...
							test:[
								/*
									- test the minimal profile syntax for registering a set-get property
									- test the complete profile syntax for registering a set-get property
						...
						},
						{
							...
							test:[
								{
									title:'Test that when no initial value is specified for a set-get property, the property\'s initial value is undefined',
									test:function () {
										var _Subclass = Uize.subclass ();
										_Subclass.registerProperties ({
											_myProperty:{name:'myProperty'}
										});
								...
								{
									title:'Test that specifying a value property in a set-get property\'s profile when registering it has the effect of setting the initial value for that property for new instances that are created',
									test:function () {
										var _Subclass = Uize.subclass ();
										_Subclass.registerProperties ({
											_myProperty:{
								...
								{
									title:'Test that null is supported as an initial value for a set-get property and that it is not treated the same as undefined',
									test:function () {
										var _Subclass = Uize.subclass ();
										_Subclass.registerProperties ({
											_myProperty:{
								...
								{
									title:'Test that the initial value registered for a property is returned as the result when querying the value of that set-get property on the class',
									test:function () {
										var _Subclass = Uize.subclass ();
										_Subclass.registerProperties ({
											_myProperty:{
								...
								{
									title:'Test that setting the value for a set-get property on the class has the effect of setting the initial value for the property',
									test:function () {
										var _Subclass = Uize.subclass ();
										_Subclass.registerProperties ({
											_myProperty:{name:'myProperty'}
								...
								{
									title:'Test that setting the value for a set-get property on the class does not affect the value of the property for instances that have already been created',
									test:function () {
										var _Subclass = Uize.subclass ();
										_Subclass.registerProperties ({
											_myProperty:{
						...
						},
						{
							...
							test:[
								{
									title:'Test that an onChange handler for a set-get property is executed on the very first change of the value of that property that occurs during construction of the instance',
									test:function () {
										var
								...
								{
									title:'Test that an onChange handler for a set-get property is only executed once upon construction when a value specified for the property in the constructor differs from the property\'s initial value',
									test:function () {
										var
											_Subclass = Uize.subclass (),
											_onChangeHandlerCount = 0
								...
								{
									title:'Test that an onChange handler is only executed when the value of a set-get property has actually changed as a result of a set - not on non-changing sets',
									test:function () {
										var
											_Subclass = Uize.subclass (),
											_onChangeCount = 0
								...
								{
									title:'Test that an onChange handler is called as a method on the instance that owns the set-get property',
									test:function () {
										var
											_Subclass = Uize.subclass (),
								...
								{
									title:'Test that the value of the set-get property has already changed by the time that an onChange handler is called',
									test:function () {
										var
											_Subclass = Uize.subclass (),
								...
								{
									title:'Test that an onChange handler can be specified by a string, where that string specifies the name of a method that must be defined for the instance',
									test:function () {
										var
											_Subclass = Uize.subclass (),
											_onChangeCount = 0
								...
								{
									title:'Test that an array of multiple onChange handlers can be specified for a set-get property, and that all of them are executed, in the order in which they appear in the array',
									test:function () {
										var
											_Subclass = Uize.subclass (),
											_coverageAndOrder = []
								...
								{
									title:'Test that an array of multiple onChange handlers may contain a mix of handlers specified by function reference, handlers specified by method name, and nested lists of handlers',
									test:function () {
										var
											_Subclass = Uize.subclass (),
											_coverageAndOrder = []
								...
								{
									title:'Test that all onChange handlers receive a single argument when it is called, which is an object containing the conformed values for all properties being set (not just those that have changed value)',
									test:function () {
										var
											_Subclass = Uize.subclass (),
										...
										;
										function _copyArguments (arguments) {
											var _result = [];
											_result.push.apply (_result,arguments);
											return _result;
										}
										_Subclass.registerProperties ({
											_foo:{
								...
								{
									title:'Test that onChange handlers are called for all set-get properties that have changed value in the course of the same set call',
									test:function () {
										var
											_Subclass = Uize.subclass (),
								...
								{
									title:'Test that an onChange handler is not called for any instances of a class when the value of the set-get property is set on the class',
									test:function () {
										var
											_Subclass = Uize.subclass (),
											_onChangeCount = 0
										...
										_onChangeCount = 0;
										_Subclass.set ({myProperty:'new initial value'});
										return _onChangeCountAfterCreatingInstances == 3 && _onChangeCount == 0;
									}
								},
								{
									title:'Test that a set-get property\'s onChange handler is only called for an instance of the class whose value for the property has changed (ie. no contamination across instances)',
									test:function () {
										var
											_Subclass = Uize.subclass (),
											_coverageAndOrder = []
								...
								{
									title:'Test that an onChange handler is only executed if the value of a set-get property has changed after being conformed, and not just if the pre-conformed value is different from the current value',
									test:function () {
										var
											_Subclass = Uize.subclass (),
								...
								{
									title:'Test that when the same onChange handler is registered for multiple set-get properties, it is only executed once - even if the values of all those properties change during a set',
									test:function () {
										var
											_Subclass = Uize.subclass (),
						...
						},
						{
							...
							test:[
								/*
									- test that a set-get property's conformer function is called with a single argument, that is the value being set for the property
									...
									- test that a conformer is called as a method on the instance that owns the set-get property
								*/
							]
						},
						{
							...
							test:[
								/*
									...
									- Test that the Changed.[propertyName] events are fired only after all the onChange handlers are executed
									- Test that the Changed.* event is fired only once when multiple set-get properties have changed value
									- Test that a handler can be wired for a Changed.[propertyName] event even before the property is registered
										- Test that wiring a handler for a Changed.[propertyName] event for a property that has not been registered causes no harm
						...
						},
						{
							...
							test:[
								/*
									...
									- Test that a handler that is wired for a set-get property using an alias name is respected
									- Test that a handler that is wired for a set-get property using an alias name can be unwired using any of its other alias names, or its canonical name
								*/
							]
						},
						{
							title:'Test the special value set-get property',
							test:[
								/*
