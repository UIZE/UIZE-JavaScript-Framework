	...
	builder:function () {
		...
		function _eventsSystemTest (_title,_isInstance) {
			function _getEventSource () {
				return _isInstance ? Uize () : Uize.subclass ();
			}
			return {
				title:_title,
				test:[
			...
			test:[
				Uize.Test.staticMethodsTest ([
					...
					['Uize.isPlainObject',[
						...
						['Test that a Uize class instance is not regarded as being a plain object',Uize (),false]
					]],
					['Uize.isPrimitive',[
						['Test that calling with no parameters returns false',[],false],
						['Test that the value undefined is not regarded as being an object',undefined,false],
					...
					['Uize.isInstance',[
						...
						['Test that a Uize instance is correctly regarded as a Uize subclass instance',Uize (),true]
					]],
					['Uize.clone',[
