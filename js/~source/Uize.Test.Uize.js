			...
			test:[
				Uize.Test.staticMethodsTest ([
					...
					['Uize.resolveTransformer',[
						{
							title:'Test that calling with no parameters produces a value transformer that always returns the input value',
							test:[
								_returnXTest (function () {return Uize.resolveTransformer ()})
							]
						},
						{
							title:'Test that specifying the value undefined produces a value transformer that always returns the input value',
							test:[
								_returnXTest (function () {return Uize.resolveTransformer (undefined)})
							]
						},
						{
							title:'Test that specifying the value null produces a value transformer that always returns the input value',
							test:[
