		...
		function _metUnmetMethodTest (_isMetTest) {
			...
			return {
				...
				test:[
					{
						title:
							'Test that the ' + _method + ' method always sets the value of the specified set-get property to ' + _isMetTest + ', regardless of the property\'s current value',
						test:function () {
							var _Class = Uize.Class.subclass ();
					...
					{
						title:'Test that the ' + _method + ' method works correctly with a set-get property that has not yet been registered',
						test:function () {
							var
								_Class = Uize.Class.subclass (),
								_instance = _Class ()
