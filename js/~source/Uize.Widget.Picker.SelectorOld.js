...
/*?
	Introduction
		The =Uize.Widget.Picker.SelectorOld= widget provides the functionality for picker widgets that require selection from a set of values.

		*DEVELOPERS:* `Ben Ilegbodu`
*/

Uize.module ({
	name:'Uize.Widget.Picker.SelectorOld',
	required:[
		'Uize.Widget.Options',
						...
						var
							...
							_options = _this.addChild(
								...
								Uize.Widget.Options,
								{
									...
									optionWidgetProperties:{allowClickWhenSelected:_true},
