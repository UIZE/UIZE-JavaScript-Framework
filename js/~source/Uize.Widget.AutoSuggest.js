							...
							_Uize_Data.NameValueRecords.toHash(
								_Uize.isArray(_quotes) ?
									typeof _quotes[0] === 'object' ?
										_quotes :
										_Uize_Data.map(function (_quote) { return { open: _quote, close: _quote} }, _quotes) :
										...
										function (_suggestion) {
										    var 
                                                ...
                                                _formattedTerm =
                                                    ...
                                                    _highlight(_suggestion.fullWord)   // hightlight the whole word if the word doesn't start with the normalizedQuery
										                                               // this is the case when the normalized query is spelled wrong
										                                                // and the suggestion comes from the spell checker
