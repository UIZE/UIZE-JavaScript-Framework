...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Build.CompileJstModules Package
|   /    / /    |
...
/*?
	Introduction
		...
		*DEVELOPERS:* `Chris van Rensburg`
		...
		The =Uize.Build.CompileJstModules= module is designed specifically to run in the context of Windows Script Host.
*/

Uize.module ({
	name:'Uize.Build.CompileJstModules',
	required:[
		'Uize.Template',
		'Uize.Wsh',
		'Uize.Build.Util'
					...
					Uize.copyInto (
						{
							targetFolderPathCreator:function (_folderPath) {
								...
								if (_targetFolderPath)
									_jstModuleTemplate = Uize.Build.Util.compileJstFile (
