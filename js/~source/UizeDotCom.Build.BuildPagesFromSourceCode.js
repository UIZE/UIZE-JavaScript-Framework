...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : UizeDotCom.Build.BuildPagesFromSourceCode Namespace
|   /    / /    |
...
/*?
	Introduction
		The =UizeDotCom.Build.BuildPagesFromSourceCode= package provides a method for building HTML pages for viewing the source code of the UIZE JavaScript modules on the *uize.com* Web site.

		*DEVELOPERS:* `Chris van Rensburg`
*/

Uize.module ({
	name:'UizeDotCom.Build.BuildPagesFromSourceCode',
	required:[
		'Uize.Wsh',
		'Uize.Build.Util',
		'Uize.Template'
