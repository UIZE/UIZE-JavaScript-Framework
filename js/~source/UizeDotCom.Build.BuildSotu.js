...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : UizeDotCom.Build.BuildSotu Namespace
|   /    / /    |
...
/*?
	Introduction
		The =UizeDotCom.Build.BuildSotu= package provides a method for building the SOTU (State of the UIZE) overview page for the modules that make up the UIZE JavaScript Framework.
...
Uize.module ({
	name:'UizeDotCom.Build.BuildSotu',
	required:[
		'Uize.Wsh',
		'Uize.Build.Util',
