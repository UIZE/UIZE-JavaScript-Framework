	...
	builder:function () {
		...
		/*** Public Static Methods ***/
			...
			_package.scrollToNode = function(_targetNode, _scrollParams) {
				...
				function _getNodeHeight(_node) { return _Uize_Node_getDimensions(_node).height }
				...
				// a node who's height is less than of its child node (which is an ancestor of _targetNode).
				...
				while (_scrollableContainerNode != null && _scrollableContainerNode != _bodyNode) {
					...
					if (_scrollableContainerNode.parentNode != _documentElement && _getNodeHeight(_scrollableContainerNode) > _getNodeHeight(_scrollableContainerNode.parentNode)) {
						_scrollableContainerNode = _scrollableContainerNode.parentNode;
						break;
					}
				}
				...
				_wireAndStartFade(
					...
					!_scrollableContainerNodeIsBodyNode && !_isNodeVisible(_targetNodeCoords)
				);
				...
				_wireAndStartFade(
					...
					!_isNodeVisible(_scrollNodeCoords)
				);
				/*?
					Static Methods
