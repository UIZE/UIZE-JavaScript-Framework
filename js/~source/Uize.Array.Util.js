	...
	builder:function () {
		/*** Variables for Scruncher Optimization ***/
			var
				...
				_fullArraySpliceArgs = [0,Infinity]
			;
		...
		/*** Public Static Methods ***/
			...
			_package.swapContents = function (_array1,_array2) {
				if (_array1 != _array2) {
					_ArrayPush.apply (
						_array1,
						_ArraySplice.apply (_array2,_fullArraySpliceArgs.concat (_array1.splice (0,Infinity)))
					);
				}
				return _array1;
				/*?
			...
			_package.flatten = function (_sourceArray,_depth,_target) {
				_depth = _depth == _undefined ? Infinity : +_depth || 0;
				var
