	...
	builder:function () {
		...
		/*** Public Static Methods ***/
			_package.fromCompactString = function (_compactStr,_encodingOptions) {
				...
				var
					_opener = Uize.defaultNull (_encodingOptions.opener,'[') + '',
					_closer = Uize.defaultNull (_encodingOptions.closer,']') + '',
					_separator = Uize.defaultNull (_encodingOptions.separator,'|') + '',
