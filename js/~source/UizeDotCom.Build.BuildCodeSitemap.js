...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : UizeDotCom.Build.BuildCodeSitemap Namespace
|   /    / /    |
...
/*?
	Introduction
		The =UizeDotCom.Build.BuildCodeSitemap= package provides a method for building an XML code sitemap for the *uize.com* Web site for all the JavaScript modules of the UIZE JavaScript Framework.
...
Uize.module ({
	name:'UizeDotCom.Build.BuildCodeSitemap',
	required:'Uize.Wsh',
	builder:function () {
