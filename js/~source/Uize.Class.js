			...
			/*** Event System Methods ***/
				...
				_classPrototype.is = function (_property) {
					...
					/*?
						Instance Methods
							is
								Returns a boolean, indicating whether or not the specified condition is met (ie. the specified condition set-get property's value is truthy).
						...
						Instance Methods
							met
								...
								For Improved Semantics
									...
									In the above example, an =initialize= instance method is defined for the class =MyClass=. In the method's implementation, after all the initialization has been performed, the =met= method is being called to indicate that the =initialized= condition has been met, where =initialized= is the name of a set-get property provided in =MyClass=. Now, other code can be registered to be executed only once an instance has been initialized by using the =once= instance method, as follows...
