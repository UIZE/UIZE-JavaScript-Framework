						...
						/*?
							Instance Methods
								expectNegativeNumber
									...
									myTest.expectNegativeNumber (Uize ({value:-5}));  // returns false
									..................................................................
						...
						/*?
							Instance Methods
								expectPositiveNumber
									...
									myTest.expectPositiveNumber (Uize ({value:5}));   // returns false
									..................................................................
					...
					/*?
						Instance Methods
							expectInteger
								...
								myTest.expectInteger (Uize ({value:10}));  // returns false
					...
					/*?
						Instance Methods
							expectNegativeInteger
								...
								myTest.expectNegativeInteger (Uize ({value:-1}));  // returns false
								myTest.expectNegativeInteger (1);                  // returns false
								myTest.expectNegativeInteger (1.5);                // returns false
								...................................................................
					...
					/*?
						Instance Methods
							expectPositiveInteger
								...
								myTest.expectPositiveInteger (Uize ({value:1}));  // returns false
								myTest.expectPositiveInteger (-1);                // returns false
								myTest.expectPositiveInteger (-1.5);              // returns false
								..................................................................
					...
					/*?
						Instance Methods
							expectNonEmptyArray
								...
								myTest.expectNonEmptyArray (Uize ({value:['foo']}));  // returns false
					...
					/*?
						Instance Methods
							expectNonEmptyObject
								...
								myTest.expectNonEmptyObject (Uize ({value:'foo'}));        // returns true
					...
					/*?
						Instance Methods
							expectNonEmptyString
								...
								myTest.expectNonEmptyString (Uize ({value:'foo'}));  // returns false
