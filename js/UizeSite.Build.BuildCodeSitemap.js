...
*/
Uize.module({name:'UizeSite.Build.BuildCodeSitemap',required:'Uize.Wsh',builder:function(){var _a=function(){};_a.perform=function(_b){var _c=/\.js$/i,_d=Uize.Wsh.getScriptFolderPath().length+1,_e=['<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:codesearch="http://www.google.com/codesearch/schemas/sitemap/1.0">'];for(var _f=0,_g=Uize.Wsh.getFiles(env.moduleFolderPath),_h=_g.length,_i;_f<_h;_f++){if(_c.test(_i=_g[_f]))_e.push('\t<url>','\t\t<loc>'+
