...
Uize.module ({
	...
	builder:function () {
		...
		function _extend (_host,_class) {
			function _resolveFadeClass (_object) {
				var _objectPrototype = _object.prototype;
				return (
					_isFunction (_objectPrototype.start) && _isFunction (_objectPrototype.stop)
						? _object
						: _class || _host
				);
			}
			...
			return Uize.copyInto (
				_host,
				{
					fade:function (_target,_startValue,_endValue,_duration,_fadeProperties,_startNow) {
						var _class = _resolveFadeClass (this);
					...
					fadeMethod:function (_context,_method,_startValue,_endValue,_duration,_fadeProperties,_startNow) {
						return _resolveFadeClass (this).fade (
					...
					fadeProperties:function (_target,_startValues,_endValues,_duration,_fadeProperties,_startNow) {
						return _resolveFadeClass (this).fadeMethod (
							_target,'set',_startValues,_endValues,_duration,_fadeProperties,_startNow
						);
						/*?
							Static Methods
					...
					fadeProperty:function (_target,_propertyName,_startValue,_endValue,_duration,_fadeProperties,_startNow) {
						var
							_startValueObj = {},
							_endValueObj = {}
						;
						...
						return _resolveFadeClass (this).fadeProperties (
							_target,_startValueObj,_endValueObj,_duration,_fadeProperties,_startNow
						);
						/*?
							Static Methods
