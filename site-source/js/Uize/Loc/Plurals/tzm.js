...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.tzm Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.tzm= module implements a .
			...
			getPluralCategory:function (_value) {
				return Uize.Loc.Plurals.Util.getPluralCategory (
					...
					function (n,i,f,t,v,w,within) {
						return within (n,[[0,1]]) || within (n,[[11,99]]) ? 'one' : 'other';
					}
				);
			}
		});
