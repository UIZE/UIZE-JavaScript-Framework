...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.it Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.it= module implements a feature for determining a plural category from a number value for the it language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.it',
