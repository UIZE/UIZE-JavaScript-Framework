...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.rm Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.rm= module implements a feature for determining a plural category from a number value for the rm language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.rm',
