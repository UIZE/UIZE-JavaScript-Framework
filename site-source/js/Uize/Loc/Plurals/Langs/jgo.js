...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.jgo Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.jgo= module implements a feature for determining a plural category from a number value for the jgo language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.jgo',
