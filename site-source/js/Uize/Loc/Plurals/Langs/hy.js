...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.hy Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.hy= module implements a feature for determining a plural category from a number value for the hy language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.hy',
