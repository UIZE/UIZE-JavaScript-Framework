...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.smi Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.smi= module implements a feature for determining a plural category from a number value for the smi language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.smi',
