...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.wo Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.wo= module implements a feature for determining a plural category from a number value for the wo language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.wo',
