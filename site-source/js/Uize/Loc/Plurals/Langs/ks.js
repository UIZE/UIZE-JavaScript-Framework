...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ks Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ks= module implements a feature for determining a plural category from a number value for the ks language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ks',
