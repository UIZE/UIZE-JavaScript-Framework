...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.hu Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.hu= module implements a feature for determining a plural category from a number value for the hu language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.hu',
