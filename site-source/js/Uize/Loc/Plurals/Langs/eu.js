...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.eu Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.eu= module implements a feature for determining a plural category from a number value for the eu language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.eu',
