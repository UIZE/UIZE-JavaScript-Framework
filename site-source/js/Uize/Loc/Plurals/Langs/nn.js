...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.nn Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.nn= module implements a feature for determining a plural category from a number value for the nn language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.nn',
