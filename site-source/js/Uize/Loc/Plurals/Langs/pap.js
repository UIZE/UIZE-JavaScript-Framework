...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.pap Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.pap= module implements a feature for determining a plural category from a number value for the pap language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.pap',
