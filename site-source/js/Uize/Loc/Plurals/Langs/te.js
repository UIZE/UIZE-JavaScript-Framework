...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.te= module implements a feature for determining a plural category from a number value for the te language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.te',
