...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.jw Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.jw= module implements a feature for determining a plural category from a number value for the jw language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.jw',
