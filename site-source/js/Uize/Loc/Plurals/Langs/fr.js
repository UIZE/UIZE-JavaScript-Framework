...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.fr Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.fr= module implements a feature for determining a plural category from a number value for the fr language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.fr',
