...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ii Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ii= module implements a feature for determining a plural category from a number value for the ii language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ii',
