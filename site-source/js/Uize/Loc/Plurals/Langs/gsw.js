...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.gsw Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.gsw= module implements a feature for determining a plural category from a number value for the gsw language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.gsw',
