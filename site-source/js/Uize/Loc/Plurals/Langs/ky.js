...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ky Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ky= module implements a feature for determining a plural category from a number value for the ky language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ky',
