...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.om Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.om= module implements a feature for determining a plural category from a number value for the om language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.om',
