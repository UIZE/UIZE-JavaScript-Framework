...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ln Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ln= module implements a feature for determining a plural category from a number value for the ln language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ln',
