...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ast Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ast= module implements a feature for determining a plural category from a number value for the ast language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ast',
