...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ksb Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ksb= module implements a feature for determining a plural category from a number value for the ksb language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ksb',
