...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.sk Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.sk= module implements a feature for determining a plural category from a number value for the sk language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.sk',
