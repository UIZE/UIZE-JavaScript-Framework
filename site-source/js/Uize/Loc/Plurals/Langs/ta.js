...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ta Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ta= module implements a feature for determining a plural category from a number value for the ta language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ta',
