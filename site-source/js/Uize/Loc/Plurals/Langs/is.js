...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.is Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.is= module implements a feature for determining a plural category from a number value for the is language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.is',
