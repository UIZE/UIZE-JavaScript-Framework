...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ses Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ses= module implements a feature for determining a plural category from a number value for the ses language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ses',
