...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.fur Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.fur= module implements a feature for determining a plural category from a number value for the fur language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.fur',
