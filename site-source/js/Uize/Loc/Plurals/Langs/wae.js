...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.wae Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.wae= module implements a feature for determining a plural category from a number value for the wae language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.wae',
