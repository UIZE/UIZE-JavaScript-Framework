...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.mgo Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.mgo= module implements a feature for determining a plural category from a number value for the mgo language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.mgo',
