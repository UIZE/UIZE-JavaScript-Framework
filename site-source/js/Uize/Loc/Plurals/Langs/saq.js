...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.saq Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.saq= module implements a feature for determining a plural category from a number value for the saq language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.saq',
