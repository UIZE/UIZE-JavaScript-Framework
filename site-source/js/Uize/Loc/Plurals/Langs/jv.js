...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.jv Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.jv= module implements a feature for determining a plural category from a number value for the jv language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.jv',
