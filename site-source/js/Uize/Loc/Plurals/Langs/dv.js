...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.dv Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.dv= module implements a feature for determining a plural category from a number value for the dv language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.dv',
