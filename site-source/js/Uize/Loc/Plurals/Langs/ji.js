...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ji Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ji= module implements a feature for determining a plural category from a number value for the ji language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ji',
