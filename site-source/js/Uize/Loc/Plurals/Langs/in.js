...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.in Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.in= module implements a feature for determining a plural category from a number value for the in language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.in',
