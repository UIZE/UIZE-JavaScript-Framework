...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.jmc Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.jmc= module implements a feature for determining a plural category from a number value for the jmc language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.jmc',
