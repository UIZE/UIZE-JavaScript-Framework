...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.sv Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.sv= module implements a feature for determining a plural category from a number value for the sv language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.sv',
