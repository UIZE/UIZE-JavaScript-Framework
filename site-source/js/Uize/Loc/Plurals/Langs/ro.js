...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ro Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ro= module implements a feature for determining a plural category from a number value for the ro language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ro',
