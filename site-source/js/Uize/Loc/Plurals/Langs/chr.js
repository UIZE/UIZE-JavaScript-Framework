...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.chr Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.chr= module implements a feature for determining a plural category from a number value for the chr language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.chr',
