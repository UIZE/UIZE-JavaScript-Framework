...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.fi Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.fi= module implements a feature for determining a plural category from a number value for the fi language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.fi',
