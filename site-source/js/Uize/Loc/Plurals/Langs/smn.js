...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.smn Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.smn= module implements a feature for determining a plural category from a number value for the smn language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.smn',
