...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.xog Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.xog= module implements a feature for determining a plural category from a number value for the xog language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.xog',
