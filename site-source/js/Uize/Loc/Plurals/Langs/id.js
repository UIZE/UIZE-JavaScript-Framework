...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.id Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.id= module implements a feature for determining a plural category from a number value for the id language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.id',
