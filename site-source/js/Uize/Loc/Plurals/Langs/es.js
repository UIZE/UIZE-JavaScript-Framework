...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.es Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.es= module implements a feature for determining a plural category from a number value for the es language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.es',
