...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ga Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ga= module implements a feature for determining a plural category from a number value for the ga language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ga',
			...
			getPluralCategory:function (_value) {
				return Uize.Loc.Plurals.Util.getPluralCategory (
					...
					function (n,i,f,t,v,w,within) {
						return n == 1 ? 'one' : n == 2 ? 'two' : within (n,[[3,6]]) ? 'few' : within (n,[[7,10]]) ? 'many' : 'other';
					}
				);
			}
		});
