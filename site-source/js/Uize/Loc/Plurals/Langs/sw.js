...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.sw Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.sw= module implements a feature for determining a plural category from a number value for the sw language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.sw',
