...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ps Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ps= module implements a feature for determining a plural category from a number value for the ps language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ps',
