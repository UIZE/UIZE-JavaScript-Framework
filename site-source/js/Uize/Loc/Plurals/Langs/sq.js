...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.sq Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.sq= module implements a feature for determining a plural category from a number value for the sq language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.sq',
