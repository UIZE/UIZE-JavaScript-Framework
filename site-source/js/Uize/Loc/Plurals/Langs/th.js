...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.th= module implements a feature for determining a plural category from a number value for the th language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.th',
