...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.os Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.os= module implements a feature for determining a plural category from a number value for the os language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.os',
