...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.xh Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.xh= module implements a feature for determining a plural category from a number value for the xh language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.xh',
