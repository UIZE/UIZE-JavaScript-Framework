...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.rof Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.rof= module implements a feature for determining a plural category from a number value for the rof language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.rof',
