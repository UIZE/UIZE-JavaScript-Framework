...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ee Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ee= module implements a feature for determining a plural category from a number value for the ee language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ee',
