...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.mas Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.mas= module implements a feature for determining a plural category from a number value for the mas language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.mas',
