...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.nah Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.nah= module implements a feature for determining a plural category from a number value for the nah language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.nah',
