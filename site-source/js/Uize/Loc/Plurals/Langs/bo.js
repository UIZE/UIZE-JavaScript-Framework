...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.bo Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.bo= module implements a feature for determining a plural category from a number value for the bo language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.bo',
