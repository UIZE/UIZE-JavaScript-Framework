...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.seh Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.seh= module implements a feature for determining a plural category from a number value for the seh language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.seh',
