...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.nl Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.nl= module implements a feature for determining a plural category from a number value for the nl language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.nl',
