...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.uz Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.uz= module implements a feature for determining a plural category from a number value for the uz language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.uz',
