...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.bn Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.bn= module implements a feature for determining a plural category from a number value for the bn language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.bn',
