...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.af Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.af= module implements a feature for determining a plural category from a number value for the af language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.af',
