...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ve Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ve= module implements a feature for determining a plural category from a number value for the ve language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ve',
