...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.st Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.st= module implements a feature for determining a plural category from a number value for the st language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.st',
