...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.or Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.or= module implements a feature for determining a plural category from a number value for the or language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.or',
