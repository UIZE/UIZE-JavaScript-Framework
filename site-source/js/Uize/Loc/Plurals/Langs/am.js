...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.am Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.am= module implements a feature for determining a plural category from a number value for the am language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.am',
