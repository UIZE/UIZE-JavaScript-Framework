...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.kab Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.kab= module implements a feature for determining a plural category from a number value for the kab language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.kab',
