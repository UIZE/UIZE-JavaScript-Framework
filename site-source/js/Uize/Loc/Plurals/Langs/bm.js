...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.bm Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.bm= module implements a feature for determining a plural category from a number value for the bm language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.bm',
