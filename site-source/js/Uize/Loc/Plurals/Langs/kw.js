...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.kw Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.kw= module implements a feature for determining a plural category from a number value for the kw language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.kw',
