...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.nd Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.nd= module implements a feature for determining a plural category from a number value for the nd language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.nd',
