...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.lo Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.lo= module implements a feature for determining a plural category from a number value for the lo language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.lo',
