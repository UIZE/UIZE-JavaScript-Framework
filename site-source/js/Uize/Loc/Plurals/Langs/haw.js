...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.haw Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.haw= module implements a feature for determining a plural category from a number value for the haw language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.haw',
