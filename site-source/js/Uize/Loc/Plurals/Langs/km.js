...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.km Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.km= module implements a feature for determining a plural category from a number value for the km language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.km',
