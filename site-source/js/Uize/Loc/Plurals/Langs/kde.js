...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.kde Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.kde= module implements a feature for determining a plural category from a number value for the kde language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.kde',
