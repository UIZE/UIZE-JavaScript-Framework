...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.bem Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.bem= module implements a feature for determining a plural category from a number value for the bem language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.bem',
