...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ha Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ha= module implements a feature for determining a plural category from a number value for the ha language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ha',
