...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.brx Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.brx= module implements a feature for determining a plural category from a number value for the brx language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.brx',
