...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ak Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ak= module implements a feature for determining a plural category from a number value for the ak language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ak',
