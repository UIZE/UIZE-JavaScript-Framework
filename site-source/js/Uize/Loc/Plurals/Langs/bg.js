...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.bg Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.bg= module implements a feature for determining a plural category from a number value for the bg language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.bg',
