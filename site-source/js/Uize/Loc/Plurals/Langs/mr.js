...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.mr Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.mr= module implements a feature for determining a plural category from a number value for the mr language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.mr',
