...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ssy Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ssy= module implements a feature for determining a plural category from a number value for the ssy language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ssy',
