...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.hi Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.hi= module implements a feature for determining a plural category from a number value for the hi language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.hi',
