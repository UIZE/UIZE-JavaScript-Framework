...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.sg Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.sg= module implements a feature for determining a plural category from a number value for the sg language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.sg',
