...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.ko Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.ko= module implements a feature for determining a plural category from a number value for the ko language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.ko',
