...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Loc.Plurals.Langs.syr Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Loc.Plurals.Langs.syr= module implements a feature for determining a plural category from a number value for the syr language.
...
Uize.module ({
	name:'Uize.Loc.Plurals.Langs.syr',
