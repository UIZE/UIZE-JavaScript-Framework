...
|     /      /  |   ---------------------------------------------------
|    /    O /   |    MODULE : Uize.Dom.VirtualEvents.Edge Package
|   /    / /    |
...
/*?
	Introduction
		The =Uize.Dom.VirtualEvents.Edge= module implements virtual DOM events that can be used to detect when the mouse enters / exits nodes at specific edges.

		*DEVELOPERS:* `Chris van Rensburg`

		In a Nutshell
			The virtual DOM events provided in the =Uize.Dom.VirtualEvents.Edge= module make it easy to wire up DOM nodes so that different things occur depending on at which edge the user enters a DOM node.
			...
			For an in-depth discussion on virtual DOM events, see the reference for the =Uize.Dom.VirtualEvent= module.

		Built-in Virtual DOM Events
			The =Uize.Dom.VirtualEvents.Edge= module provides two main categories of built-in virtual DOM events: `mouse-enter-at-edge virtual DOM events` and `mouse-exit-at-edge virtual DOM events`.
			...
			Mouse-enter-at-edge Virtual DOM Events
				...
				Mouse-enter-at-edge Virtual DOM Event Static Methods
					The =Uize.Dom.VirtualEvents.Edge= module provides the following static methods for making `mouse-enter-at-edge virtual DOM events`...

					- =Uize.Dom.VirtualEvents.Edge.mouseEnterLeft=
					- =Uize.Dom.VirtualEvents.Edge.mouseEnterRight=
					- =Uize.Dom.VirtualEvents.Edge.mouseEnterTop=
					- =Uize.Dom.VirtualEvents.Edge.mouseEnterBottom=

				Mouse-enter-at-edge Registered Virtual DOM Event
					The =Uize.Dom.VirtualEvents.Edge= module registers the following event names for `mouse-enter-at-edge virtual DOM events`...
			...
			Mouse-exit-at-edge Virtual DOM Events
				...
				Mouse-exit-at-edge Virtual DOM Event Static Methods
					The =Uize.Dom.VirtualEvents.Edge= module provides the following static methods for making `mouse-exit-at-edge virtual DOM events`...

					- =Uize.Dom.VirtualEvents.Edge.mouseExitLeft=
					- =Uize.Dom.VirtualEvents.Edge.mouseExitRight=
					- =Uize.Dom.VirtualEvents.Edge.mouseExitTop=
					- =Uize.Dom.VirtualEvents.Edge.mouseExitBottom=

				Mouse-exit-at-edge Registered Virtual DOM Event
					The =Uize.Dom.VirtualEvents.Edge= module registers the following event names for `mouse-exit-at-edge virtual DOM events`...
...
Uize.module ({
	name:'Uize.Dom.VirtualEvents.Edge',
	required:[
		'Uize.Dom.Basics',
		'Uize.Dom.Pos',
	...
	builder:function () {
		...
		var
			/*** Variables for Scruncher Optimization ***/
				...
				_getStyle = _Uize_Dom.Basics.getStyle,

			/*** General Variables ***/
				_edgeNames = ['left','right','top','bottom']
		;
									...
									function (_event) {
										...
										var
											_xRelative =
												(
													_eventAbsPos.left -
													_nodeCoords.left + parseFloat (_getStyle (this,'borderLeftWidth'))
												)
												/ _nodeCoords.width,
											_yRelative =
												(
													_eventAbsPos.top -
													_nodeCoords.top + parseFloat (_getStyle (this,'borderTopWidth'))
												)
												/ _nodeCoords.height,
					...
					/*?
						Static Methods
							Uize.Dom.VirtualEvents.Edge.mouseEnterLeft
								...
								SYNTAX
								...................................................................
								virtualDomEventOBJ = Uize.Dom.VirtualEvents.Edge.mouseEnterLeft ();
								...................................................................
						...
						Registered Virtual DOM Events
							mouseEnterLeft
								The registered name for the `virtual DOM event maker` that is implemented in the =Uize.Dom.VirtualEvents.Edge.mouseEnterLeft= static method.
								...
								EXAMPLE
								.......................................................................................
								Uize.Node.Basics.wire ('myNode','mouseEnterLeft()',function () {alert ('ENTER LEFT')});
								.......................................................................................
					...
					/*?
						Static Methods
							Uize.Dom.VirtualEvents.Edge.mouseEnterRight
								...
								SYNTAX
								....................................................................
								virtualDomEventOBJ = Uize.Dom.VirtualEvents.Edge.mouseEnterRight ();
								....................................................................
						...
						Registered Virtual DOM Events
							mouseEnterRight
								The registered name for the `virtual DOM event maker` that is implemented in the =Uize.Dom.VirtualEvents.Edge.mouseEnterRight= static method.
								...
								EXAMPLE
								.........................................................................................
								Uize.Node.Basics.wire ('myNode','mouseEnterRight()',function () {alert ('ENTER RIGHT')});
								.........................................................................................
					...
					/*?
						Static Methods
							Uize.Dom.VirtualEvents.Edge.mouseEnterTop
								...
								SYNTAX
								..................................................................
								virtualDomEventOBJ = Uize.Dom.VirtualEvents.Edge.mouseEnterTop ();
								..................................................................
						...
						Registered Virtual DOM Events
							mouseEnterTop
								The registered name for the `virtual DOM event maker` that is implemented in the =Uize.Dom.VirtualEvents.Edge.mouseEnterTop= static method.
								...
								EXAMPLE
								.....................................................................................
								Uize.Node.Basics.wire ('myNode','mouseEnterTop()',function () {alert ('ENTER TOP')});
								.....................................................................................
					...
					/*?
						Static Methods
							Uize.Dom.VirtualEvents.Edge.mouseEnterBottom
								...
								SYNTAX
								.....................................................................
								virtualDomEventOBJ = Uize.Dom.VirtualEvents.Edge.mouseEnterBottom ();
								.....................................................................
						...
						Registered Virtual DOM Events
							mouseEnterBottom
								The registered name for the `virtual DOM event maker` that is implemented in the =Uize.Dom.VirtualEvents.Edge.mouseEnterBottom= static method.
								...
								EXAMPLE
								...........................................................................................
								Uize.Node.Basics.wire ('myNode','mouseEnterBottom()',function () {alert ('ENTER BOTTOM')});
								...........................................................................................
					...
					/*?
						Static Methods
							Uize.Dom.VirtualEvents.Edge.mouseExitLeft
								...
								SYNTAX
								..................................................................
								virtualDomEventOBJ = Uize.Dom.VirtualEvents.Edge.mouseExitLeft ();
								..................................................................
						...
						Registered Virtual DOM Events
							mouseExitLeft
								The registered name for the `virtual DOM event maker` that is implemented in the =Uize.Dom.VirtualEvents.Edge.mouseExitLeft= static method.
								...
								EXAMPLE
								.....................................................................................
								Uize.Node.Basics.wire ('myNode','mouseExitLeft()',function () {alert ('EXIT LEFT')});
								.....................................................................................
					...
					/*?
						Static Methods
							Uize.Dom.VirtualEvents.Edge.mouseExitRight
								...
								SYNTAX
								...................................................................
								virtualDomEventOBJ = Uize.Dom.VirtualEvents.Edge.mouseExitRight ();
								...................................................................
						...
						Registered Virtual DOM Events
							mouseExitRight
								The registered name for the `virtual DOM event maker` that is implemented in the =Uize.Dom.VirtualEvents.Edge.mouseExitRight= static method.
								...
								EXAMPLE
								.......................................................................................
								Uize.Node.Basics.wire ('myNode','mouseExitRight()',function () {alert ('EXIT RIGHT')});
								.......................................................................................
					...
					/*?
						Static Methods
							Uize.Dom.VirtualEvents.Edge.mouseExitTop
								...
								SYNTAX
								.................................................................
								virtualDomEventOBJ = Uize.Dom.VirtualEvents.Edge.mouseExitTop ();
								.................................................................
						...
						Registered Virtual DOM Events
							mouseExitTop
								The registered name for the `virtual DOM event maker` that is implemented in the =Uize.Dom.VirtualEvents.Edge.mouseExitTop= static method.
								...
								EXAMPLE
								...................................................................................
								Uize.Node.Basics.wire ('myNode','mouseExitTop()',function () {alert ('EXIT TOP')});
								...................................................................................
					...
					/*?
						Static Methods
							Uize.Dom.VirtualEvents.Edge.mouseExitBottom
								...
								SYNTAX
								....................................................................
								virtualDomEventOBJ = Uize.Dom.VirtualEvents.Edge.mouseExitBottom ();
								....................................................................
						...
						Registered Virtual DOM Events
							mouseExitBottom
								The registered name for the `virtual DOM event maker` that is implemented in the =Uize.Dom.VirtualEvents.Edge.mouseExitBottom= static method.
								...
								EXAMPLE
								.........................................................................................
								Uize.Node.Basics.wire ('myNode','mouseExitBottom()',function () {alert ('EXIT BOTTOM')});
								.........................................................................................
