...
Uize.module ({
	...
	builder:function (_class) {
		...
		/*** Public Instance Methods ***/
			_classPrototype.blend = function (_color1,_color2,_blendAmount) {
			...
			_classPrototype.equal = function (_color) {
			...
			_classPrototype.random = function () {
				for (
					var
		...
		/*** Public Static Methods ***/
			_class.blend = function (_color1,_color2,_blendAmount,_encoding) {
			...
			_class.equal = function (_color1,_color2) {
			...
			_class.random = function (_encoding) {
