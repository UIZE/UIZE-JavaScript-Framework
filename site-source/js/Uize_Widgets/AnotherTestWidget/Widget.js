...
/*?
	Introduction
		The =Uize.Widgets.AnotherTestWidget.Widget= class implements a test widget being used during development of the new =Uize.Widget.V2= widget base class to test this class' functionality.
