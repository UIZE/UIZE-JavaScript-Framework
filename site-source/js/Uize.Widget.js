	...
	builder:function (_superclass) {
		...
		/*** Private Instance Methods ***/
			_class.instanceMethods ({
				_harvestDeclarativeWidgetProperties:function (_idPrefix,_parent) {
					var
						_properties,
						_globalVariableName
					;
				...
				_constructIdPrefix:function (
					_parentIdPrefix,_childIdPrefix,_childName,_idPrefixConstruction
				) {
					return (
